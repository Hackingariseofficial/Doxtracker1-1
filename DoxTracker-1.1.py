...
# Dev: Python
#
# Updated for python 3.x By: Mutiny27
# Date: 06/03/2019
# ~~~~~~~~~~~ INFO ~~~~~~~~~~~~
#
#     Simple Doxing tool
...
\033[1;31m  88\033[1;33m8P' `Y8P'\033[1;32m dP Yb   8\033[1;36m   8    `Y88 `Y8\033[1;34mP 8 Yb `Y88P 8
     \033[1;31mPeOpLe TrAcKeR\033[1;m \033[1;34mBY\033[1;m KURO-CODE AND UPDATED BY MUTINY27 \033[1;33mVersion:\033[1;32m Beta 1.0\033[1;35m
     """)
...
\033[1;36m       99. About
    ...
    if OPT == "1":
        ...
        LOGO()
        print(
        "\033[1;31m[ERROR]\033[1;m selection invalid!")
        time.sleep(3)
        menu()
...
\033[1;36m    99. About\033[1;31m    0. Exit
    ...
    if Tracker == "1":
        ...
        KURO()
        webbrowser.open(
            'https://www.beenverified.com/lp/e030ee/1/loading?utm_id=peekyou_Peekyou_Contact_Address_Results_Button&age=&bvid=&city=&fn=' + Name + '&ln=' + F_name)
        time.sleep(2)
        menu()
    elif Tracker == "12":
        KURO()
        webbrowser.open(
            'https://www.peoplelooker.com/lp/5ee6b8/1/loading?utm_id=peekyou_peekyou_PL_phonebook_widget_web&fn=' + Name + '&ln=' + F_name + '&city=&state=&age=&bvid=&utm_source=peekyou&utm_medium=channel_partner&utm_campaign=peekyou_PL_phonebook_widget_web&utm_content=static#.')
        time.sleep(2)
        menu()
    elif Tracker == "13":
        KURO()
...
\033[1;36m    99. Back\033[1;31m    0. Exit
    ...
    if Tracker == "1":
        ...
        KURO()
        webbrowser.open(
            'http://enmemoria.lavanguardia.com/buscar?keywords=' + Name + '+' + F_name + '&type=death&_fstatus=search')
        time.sleep(2)
        menu()
    elif Tracker == "00":
        KURO()
...
def EXITMENU():
    ...
    time.sleep(1)
    print(
    "\033[1;m Thanks for using DoxTracker\033[1;m")
    time.sleep(2)
    print()
    print(
    "\033[1;m[\033[1;31mX\033[1;m]...\033[1;32mClosing")
    time.sleep(1)
    KURO()
    sys.exit()
